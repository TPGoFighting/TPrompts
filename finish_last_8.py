...
# 找出这 8 个文件的内容
missing_ids = {'cmmx2lu6d0001l804foa0s1mz', 'cmmx2pcnd0001k604fhc6cq9k', 'cmj8gwumj000yv40rm9hmcuba', 'cmmx3jj8c000hk604w8fmzk8j', 'cmj8fpwoe0001uh0qt4lo47wp', 'cmmx3kakv0017il04axj51zi2', 'cmoka75o60004l404kpaw0njw', 'cmj9l3pkq0001u10s1a0x9lcm'}
...
print(f"待处理最后超长提示词: {len(todo)} 条")

for it in todo:
    print(f"正在处理: {it['id']} ({it['title']}) 字符数: {len(it['prompt'])}...")
