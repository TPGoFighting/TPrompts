...
**Description:** Generate an image collage using a strict reference image, adhering to detailed wardrobe, scene, and aesthetic specifications.

**Type:** TEXT
**Author:** cipeberre
**Created:** 2025-12-15T05:28:01.522Z
**Votes:** 0
**Views:** 0
...
**Source:** https://prompts.chat/prompts/cmj6pq50x0008yq0swhrr299j_editorial-winter-posterstyle-multi-panel-collage-generation
...
## 使用说明
### 这个提示词能帮你做什么
这是一个**UI/UX设计与视觉创作**类的提示词。Generate an image collage using a strict reference image, adhering to detailed wardrobe, scene, and aesthetic specifications.
