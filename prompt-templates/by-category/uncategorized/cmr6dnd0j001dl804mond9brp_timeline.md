...
**Type:** TEXT
**Author:** kennynah85
**Created:** 2026-07-04T13:07:35.204Z
**Votes:** 0
**Views:** 0
...
**Source:** https://prompts.chat/prompts/cmr6dnd0j001dl804mond9brp_timeline
...
## 使用说明
### 这个提示词能帮你做什么
这是一个**UI/UX设计与视觉创作**类的提示词。timeline
...
6. 根据结果进一步调整或追问
### 可自定义变量
- `${event_description}`: 需要您填写
- `${event_description}`: 需要您填写
- `${event_description}`: 需要您填写
- `${any_dates_marked_uncertain}`: 需要您填写
- `${any_events_where_sequence_is_unclear}`: 需要您填写
