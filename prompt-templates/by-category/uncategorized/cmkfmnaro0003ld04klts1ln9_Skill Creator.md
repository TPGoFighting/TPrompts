...
**Type:** SKILL
**Author:** f
**Created:** 2026-01-15T15:51:28.069Z
**Votes:** 2
**Views:** 0
...
**Source:** https://prompts.chat/prompts/cmkfmnaro0003ld04klts1ln9_skill-creator
...
## 使用说明
### 这个提示词能帮你做什么
这是一个**编程代码生成与审查**类的提示词。Guide for creating effective skills. This skill should be used when users want to create a new skill (or update an existing skill) that extends Claude's capabilities with specialized knowledge, workflows, or tool integrations.
