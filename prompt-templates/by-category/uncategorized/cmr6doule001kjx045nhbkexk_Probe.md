...
**Type:** TEXT
**Author:** kennynah85
**Created:** 2026-07-04T13:08:44.642Z
**Votes:** 0
**Views:** 0
...
**Source:** https://prompts.chat/prompts/cmr6doule001kjx045nhbkexk_probe
...
6. 根据结果进一步调整或追问
### 可自定义变量
- `${question_about_what_the_content_takes_for_granted}`: 需要您填写
- `${question_about_what_follows_if_this_is_true}`: 需要您填写
