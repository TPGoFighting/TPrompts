...
**Description:** 2D classic cartoon animation, bright warm colors, exaggerated expressions.

Characters: Consistent orange chubby cat with green eyes. Small brown mouse with big ears. Keep same design all videos.

Scene: Cozy kitchen Sunday morning. Sunlight, fridge with note, small table, sunbeam.

Action: Mouse eats toast, milk, strawberry at tiny table. Cat sleeps in sunbeam with fish thought bubble. Calm.

Mood: Peaceful, cozy, wholesome. NO talking. NO text. 
Video length: 7 seconds

**Type:** TEXT
**Author:** raphaeldaniel244
**Created:** 2026-07-28T20:34:14.755Z
**Votes:** 0
**Views:** 0
...
**Source:** https://prompts.chat/prompts/cms5467oj0001js04y1nx9t97_the-greedy-cat
...
## 使用说明
### 这个提示词能帮你做什么
这是一个**UI/UX设计与视觉创作**类的提示词。2D classic cartoon animation, bright warm colors, exaggerated expressions.
