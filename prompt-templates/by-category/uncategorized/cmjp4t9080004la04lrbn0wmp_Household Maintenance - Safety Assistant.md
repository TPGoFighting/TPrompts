...
**Description:** Help users safely assess household maintenance issues, determine whether they can fix the issue themselves or need a professional, and gather all relevant information needed for fast, accurate repair.

**Type:** TEXT
**Author:** thanos0000
**Created:** 2025-12-28T02:50:12.057Z
**Votes:** 0
**Views:** 0
...
**Source:** https://prompts.chat/prompts/cmjp4t9080004la04lrbn0wmp_household-maintenance-safety-assistant
...
## 使用说明
### 这个提示词能帮你做什么
这是一个**编程代码生成与审查**类的提示词。Help users safely assess household maintenance issues, determine whether they can fix the issue themselves or need a professional, and gather all relevant information needed for fast, accurate repair.
