...
**Type:** TEXT
**Author:** furkangtgg
**Created:** 2026-05-23T17:55:07.188Z
**Votes:** 0
**Views:** 0
...
**Source:** https://prompts.chat/prompts/cmpinfcqc0001kw04w967yi0f_promot
...
```
电影介绍动画。深海军蓝色背景，具有微妙的粒子效果。 
大号粗体白色文字“MARMARA MPDS”出现青色发光效果，逐个字母表示 PDS，颜色效果仅影响 PDS 字母，M 字母为白色。 
在其下方，较小的文字“Fikirleri Projeye Dönüştürüyoruz”淡入。 
未来派、简约的科技美学。没有人。
```

## 使用说明
### 这个提示词能帮你做什么
这是一个**视频与动画制作**类的提示词。它可以帮助你完成与Promot相关的任务。
