...
**Type:** SKILL
**Author:** kriptoburak
**Created:** 2026-04-14T16:32:52.752Z
**Votes:** 0
**Views:** 0
...
**Source:** https://prompts.chat/prompts/cmnyubdao0001jt04bzxg4s9m_x-twitter-scraper
...
| API规范| `探索` MCP 工具或 [docs.xquik.com/api-reference/overview](https://docs.xquik.com/api-reference/overview) |端点参数、响应形状 |
| MCP | 文档`https://docs.xquik.com/mcp`（无身份验证）|从 AI 工具搜索文档 |
...
## 使用说明
### 这个提示词能帮你做什么
这是一个**编程代码生成与审查**类的提示词。X (Twitter) data platform skill for AI coding agents. 122 REST API endpoints, 2 MCP tools, 23 extraction types, HMAC webhooks. Reads from $0.00015/call - 66x cheaper than the official X API. Works with Claude Code, Cursor, Codex, Copilot, Windsurf & 40+ agents.
