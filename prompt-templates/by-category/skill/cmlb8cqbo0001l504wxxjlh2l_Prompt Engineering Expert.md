...
**Type:** SKILL
**Author:** tomstools11
**Created:** 2026-02-06T18:39:58.017Z
**Votes:** 3
**Views:** 0
...
**Source:** https://prompts.chat/prompts/cmlb8cqbo0001l504wxxjlh2l_prompt-engineering-expert
...
## 使用说明
### 这个提示词能帮你做什么
这是一个**编程代码生成与审查**类的提示词。This skill equips Claude with deep expertise in prompt engineering, custom instructions design, and prompt optimization. It provides comprehensive guidance on crafting effective AI prompts, designing agent instructions, and iteratively improving prompt performance.
