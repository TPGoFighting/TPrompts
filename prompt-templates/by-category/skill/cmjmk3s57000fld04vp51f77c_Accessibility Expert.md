...
**Type:** SKILL
**Author:** izzetemre
**Created:** 2025-12-26T07:34:59.132Z
**Votes:** 1
**Views:** 0
...
**Source:** https://prompts.chat/prompts/cmjmk3s57000fld04vp51f77c_accessibility-expert
...
## 使用说明
### 这个提示词能帮你做什么
这是一个**编程代码生成与审查**类的提示词。Tests and remediates accessibility issues for WCAG compliance and assistive technology compatibility. Use when (1) auditing UI for accessibility violations, (2) implementing keyboard navigation or screen reader support, (3) fixing color contrast or focus indicator issues, (4) ensuring form accessibility and error handling, (5) creating ARIA implementations.
...
- `${component_name}`: 可自定义（默认值: Application）
- `${compliance_standard}`: 可自定义（默认值: WCAG 2.1）
- `${testing_scope}`: 可自定义（默认值: full-audit）
