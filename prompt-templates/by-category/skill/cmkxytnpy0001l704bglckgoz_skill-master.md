...
**Description:** Analyzes codebase patterns to discover missing skills and generate/update SKILL.md files in .claude/skills/ with real, repo-derived examples.

**Type:** SKILL
**Author:** barisatalay
**Created:** 2026-01-28T11:52:11.348Z
**Votes:** 5
**Views:** 0
...
**Source:** https://prompts.chat/prompts/cmkxytnpy0001l704bglckgoz_skill-master
...
分析代码库以发现模式并在“.claude/skills/”中生成/更新 SKILL 文件。支持具有特定于堆栈的模式检测的多平台项目。
...
## 使用说明
### 这个提示词能帮你做什么
这是一个**编程代码生成与审查**类的提示词。Analyzes codebase patterns to discover missing skills and generate/update SKILL.md files in .claude/skills/ with real, repo-derived examples.
