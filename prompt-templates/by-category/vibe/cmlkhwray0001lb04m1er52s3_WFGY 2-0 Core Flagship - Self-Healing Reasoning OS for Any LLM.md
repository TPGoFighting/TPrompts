...
**Description:** A long-form system prompt that wraps any strong LLM (ChatGPT, Claude, Gemini, etc.) with a “reasoning OS”.
...
**Type:** TEXT
**Author:** onestardao
**Created:** 2026-02-13T06:17:24.537Z
**Votes:** 0
**Views:** 0
...
**Source:** https://prompts.chat/prompts/cmlkhwray0001lb04m1er52s3_wfgy-20-core-flagship-self-healing-reasoning-os-for-any-llm
...
## 使用说明
### 这个提示词能帮你做什么
这是一个**编程代码生成与审查**类的提示词。A long-form system prompt that wraps any strong LLM (ChatGPT, Claude, Gemini, etc.) with a “reasoning OS”.
