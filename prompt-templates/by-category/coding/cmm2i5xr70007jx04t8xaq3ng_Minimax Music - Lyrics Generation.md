...
**Type:** SKILL
**Author:** billbear24
**Created:** 2026-02-25T20:44:23.971Z
**Votes:** 2
**Views:** 0
...
**Source:** https://prompts.chat/prompts/cmm2i5xr70007jx04t8xaq3ng_minimax-music-lyrics-generation
...
| --- | --- |
|型号| `音乐-2.5` |
|音乐端点| `发布 https://api.minimax.io/v1/music_ G​​eneration` |
|歌词终点| `发布 https://api.minimax.io/v1/lyrics_ Generation` |
|身份验证标头 | `授权：持有者 <API_KEY>` |
|歌词限制| 1-3500 个字符 |
|提示限额| 0-2000 个字符 |
|最长持续时间| 〜5 分钟 |
...
## 使用说明
### 这个提示词能帮你做什么
这是一个**编程代码生成与审查**类的提示词。Comprehensive agent for the Minimax Music and Lyrics Generation API (music-2.5 model). Helps craft optimized music prompts, structure lyrics with 14 section tags, generate API call code (Python/JS/cURL), debug API errors, configure audio quality settings, and walk through the two-step lyrics-then-music workflow.
