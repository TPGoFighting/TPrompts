...
**Description:** 显示GitHub热门项目趋势，支持每周/每日列表和编程语言筛选

**Type:** SKILL
**Author:** xiamingxing725
**Created:** 2026-01-20T06:27:06.683Z
**Votes:** 3
**Views:** 0
...
**Source:** https://prompts.chat/prompts/cmkm7oshn0004l204f8mr4gin_githubtrends
...
---
名称：GitHub趋势
描述：显示GitHub热门项目趋势，生成可视化仪表板。USE WHEN github趋势、热门项目、热门仓库、热门github项目、生成仪表板、创建网页。
版本：2.0.0
---
...
如果此目录存在，则加载并应用其中找到的任何 PREFERENCES.md、配置或资源。这些会覆盖默认行为。如果该目录不存在，则继续使用技能默认值。

# GitHubTrends - GitHub 热门项目趋势

**快速找到GitHub上最受欢迎的开源项目。**

---

## 理念

GitHub 趋势是发现优质项目的最佳途径。这个技能让老王我可以快速获取当前最热门的项目列表，按时间周期（每日开源/每周）和编程语言筛选，帮助发现值得学习和贡献的项目。
...
## 使用说明
### 这个提示词能帮你做什么
这是一个**UI/UX设计与视觉创作**类的提示词。显示GitHub热门项目趋势，支持每周/每日列表和编程语言筛选
