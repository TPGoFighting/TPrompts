...
**Type:** TEXT
**Author:** gokbeyinac
**Created:** 2026-03-13T09:54:23.797Z
**Votes:** 0
**Views:** 0
...
**Source:** https://prompts.chat/prompts/cmmopznp10009le041evkm0nx_design-handoff-notes-ai-first-human-readable
...
## 使用说明
### 这个提示词能帮你做什么
这是一个**编程代码生成与审查**类的提示词。Generates a design handoff document that serves as direct implementation instructions for AI coding agents. Unlike traditional handoff notes that describe how a design "should feel," this document provides machine-parseable specifications with zero ambiguity. Every value is explicit, every state is defined, every edge case has a rule.
